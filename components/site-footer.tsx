...
export function SiteFooter() {
  return (
    <footer className="mt-24 border-t border-border bg-brand-gradient">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center gap-2">
            ...
            <div className="font-display text-white font-bold text-lg">Farhan Ali</div>
          </div>
      ...
      <div className="border-t border-white/20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-center gap-2 text-xs text-white">
