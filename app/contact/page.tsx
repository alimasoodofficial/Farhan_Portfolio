...
export default function ContactPage() {
  return (
    <section className="relative overflow-hidden z-0 min-h-[calc(100vh-4rem)]">
      {/* Dynamic Backgrounds */}
      <div className="absolute inset-0 bg-grid opacity-40 [mask-image:radial-gradient(ellipse_at_top_left,black_30%,transparent_80%)]" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24 z-10">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-4 font-display text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-foreground leading-[1.1]">
            ...
            <span className="relative inline-block">
              <span className="relative z-10 text-brand">emissions.</span>
              <span className="absolute inset-x-0 bottom-1 h-3 sm:h-4 bg-highlight/70 dark:bg-highlight/60 -z-10 rounded-sm" />
            </span>
          </h1>
          
          <p className="mt-4 text-lg text-muted-foreground max-w-xl">
            Whether you want to audit a cement facility, scope a sensor network, or book an hours-based consulting slot, I'm here to help.
          </p>
        </div>
