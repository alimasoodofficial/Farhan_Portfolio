...
import { ArrowRight, BookOpen, Scroll, CheckCircle, Database } from "lucide-react";
      ...
      <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="relative rounded-3xl border border-border bg-card/60 backdrop-blur-md p-3 shadow-xl hover:border-brand/40 transition-all duration-300">
            <div className="relative aspect-[4/5] w-full rounded-2xl overflow-hidden">
              <PreviewableImage
                ...
                alt="Farhan Ali - scholastic publications and book chapters"
              ...
              <div className="absolute bottom-4 left-4 right-4 z-20 rounded-2xl bg-neutral-900/80 backdrop-blur-md border border-white/10 p-3 text-white text-xs font-semibold flex items-center gap-2">
                <Scroll className="size-4 text-brand" />
                <span>Peer-reviewed scientific releases</span>
              </div>
            </div>
          </div>
        </div>

        {/* Narrative & Scholastics (Right) */}
        <div className="lg:col-span-7 space-y-6">
          ...
          <h3 className="font-display text-3xl sm:text-4xl font-extrabold tracking-tight text-foreground leading-[1.2]">
            Scientific publications & atmospheric dispersion models.
          </h3>

          <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            I contribute actively to scholastic research, authoring studies on hazardous waste classification, air pollution metrics, and dispersion modeling. My scholastic outputs bridges academic rigor with active field engineering.
          </p>
          ...
          <div className="grid sm:grid-cols-2 gap-4 pt-2">
            <div className="group/item flex items-start gap-3 rounded-2xl border border-border bg-card/45 p-4 shadow-sm hover:border-brand/35 hover:-translate-y-0.5 hover:shadow-md transition-all duration-300">
              ...
              <div>
                <h5 className="font-bold text-xs sm:text-sm text-foreground">Book Chapter</h5>
                <p className="text-[11px] text-muted-foreground mt-0.5">Focusing on hazardous waste management.</p>
              </div>
            </div>
            ...
            <div className="group/item flex items-start gap-3 rounded-2xl border border-border bg-card/45 p-4 shadow-sm hover:border-brand/35 hover:-translate-y-0.5 hover:shadow-md transition-all duration-300">
              ...
              <div>
                <h5 className="font-bold text-xs sm:text-sm text-foreground">Dispersion Models</h5>
                <p className="text-[11px] text-muted-foreground mt-0.5">Mapping atmospheric plumes and compliance.</p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-4">
            ...
            >
              Access Scientific Archives <ArrowRight className="size-4 text-brand transition-transform group-hover:translate-x-0.5" />
            </Link>
          </div>
        </div>
